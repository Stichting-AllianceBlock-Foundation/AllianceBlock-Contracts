...
//     shouldBehaveLikeERC20Transfer(errorPrefix, initialHolder, recipient, initialSupply, function (from: string, to: string, value: string) {
...
//       recipient,
//       initialSupply,
//       function (owner: string, spender: string, amount: string) {
